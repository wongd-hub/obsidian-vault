...
Why are we obsessed with having a normal distribution? Because once we have a normal sampling distribution, we can start calculating probabilities, [[2. Confidence Intervals|confidence intervals]], and p-values for hypothesis tests.
